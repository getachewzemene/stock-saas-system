  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-gradient-to-br from-white via-gray-50 to-white border border-gray-200 shadow-lg fixed z-50 flex h-auto flex-col dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 dark:border-gray-700 dark:text-white",
